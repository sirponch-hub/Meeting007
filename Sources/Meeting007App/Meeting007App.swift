        ...
        VStack(alignment: .leading, spacing: 10) {
            ...
            VStack(alignment: .leading, spacing: 12) {
                ...
                if shouldShowPreview {
                    TranscriptStatusBanner(isRecording: state.isRecording)

                    if segments.isEmpty {
                        VStack(alignment: .leading, spacing: 4) {
                            Text("Transcript segments will appear here.")
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 6) {
            Text("Your transcript will appear here")
                .font(.headline)
            Text("Start recording to see live local Russian transcription.")
                .foregroundStyle(.secondary)
        }
    }
}
...
struct TranscriptStatusBanner: View {
    let isRecording: Bool
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 4) {
            ...
            Text(isRecording ? "Local Russian transcription is running on this Mac." : "This transcript was generated locally for the current session.")
                .font(.callout)
                .foregroundStyle(.secondary)
        }
        .accessibilityElement(children: .combine)
